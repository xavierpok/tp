...
import connexion.storage.AddressBookStorage;
import connexion.storage.JsonAddressBookStorage;
import connexion.storage.JsonUserPrefsStorage;
import connexion.storage.Storage;
import connexion.storage.StorageManager;
import connexion.storage.UserPrefsStorage;
import connexion.ui.Ui;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing Connexion ]===========================");
        super.init();
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting Connexion " + MainApp.VERSION);
