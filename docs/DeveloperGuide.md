...
4. #### Deal with text-wrapping in UI
   1. The current implementation of the personViewPanel truncates text subjective to the window size, making users unable to view extremely long text in the UI.
